/*
    ...
    Informações: Classe responsavel por fazer a alteracao da senha do usuario
*/
using System;
...
namespace UNA.PraticasProgramacao.Web.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "Sua senha precisa ter no mínimo 6 caracteres", MinimumLength = 6)]
            [DataType(DataType.Password)]
